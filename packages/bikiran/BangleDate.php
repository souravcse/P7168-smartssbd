...
class BangleDate
{
    ...
    {
        $this->BangleDate($timestamp, $hour);
    }

    /*
    * PHP4 Legacy constructor
    */
    function BangleDate($timestamp, $hour = 6)
    {
