...
class ModelFooter
{
    function getHtml(): string
    {
        ...
        <div class=\"footer-top  bg-gradient text-white ptb-120\" style=\"background: url('/assets/template-smartssbd/img/page-header-bg.svg')no-repeat bottom right\">
            <div class=\"container\">
                ...
                <div class=\"row justify-content-between align-items-center\">
                    <div class=\"col-md-7 col-lg-7\">
                        <div class=\"copyright-text\">
                            <p class=\"mb-lg-0 mb-md-0\">&copy; ".date("Y",getTime()) ." Smart Solution For Software Rights Reserved.</p>
                        </div>
                    </div>
