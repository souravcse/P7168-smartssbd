                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="address" placeholder="Enter Address"
                                      id="compnayNameinput"></textarea>
                        </div>
                    </div><!--end col-->
                    <div class="col-6">
                        <div class="mb-3">
                            <label for="phonenumberInput" class="form-label">Phone Number</label>
                            <input type="tel" class="form-control" name="email" placeholder="+88012345678"
                                   id="phonenumberInput">
                        </div>
                    </div><!--end col-->
                    <div class="col-6">
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" name="contact" placeholder="example@gamil.com"
                                   id="emailidInput">
                        </div>
                    </div><!--end col-->
