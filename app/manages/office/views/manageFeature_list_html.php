...
foreach ($featureInfo_all_ar as $det_ar) {
    $tr .= "<tr> 
            ...
            <td><img src=" . $det_ar['icon_url'] . " alt='' style=\"width: 50px\"> </td>
            <td>" . $det_ar['status'] . "</td>
            <td> 
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="title" placeholder="Enter Feature Name"
                                   id="title">
                        </div>
                    </div><!--end col-->
                    <div class="col-12">
...
<script>
    $('#create-btn').on('click', function () {
        ...
        $form.trigger('reset').attr('action', '<?= mkUrl("manage/feature-list/create") ?>').attr('data-mode', 'create');
    ...
    $('.edit-btn').on('click', function () {
        ...
        $form.trigger('reset').attr('action', '<?= mkUrl("manage/feature-list/{sl}/update", ['sl' => "' + id + '"]) ?>').attr('data-mode', 'update');

        $.post('<?= mkUrl("manage/feature-list/{sl}/info/json", ['sl' => "' + id + '"]) ?>', function (data) {
            $('#title').val(data['title']);
            $('#description').val(data['description']);
            $('#image_url').val(data['icon_url']).change();
        }, "json");
    ...
    $('.remove-btn').on('click', function () {
        ...
        $title.html('Edit Client');
        $form.trigger('reset').attr('action', '<?= mkUrl("manage/feature-list/{sl}/remove", ['sl' => "' + id + '"]) ?>').attr('data-mode', 'update');
